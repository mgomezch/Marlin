...
#define STRING_CONFIG_H_AUTHOR "(smcgroty, for Ender 6, modified for SKR2 by mgomezch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Constanza"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3.71, -25.3, -2.5 }
...
=======
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.
>>>>>>> 6e7b6396df (Constanza: Ender 6 on SKR2 by mgomezch@)
#endif
